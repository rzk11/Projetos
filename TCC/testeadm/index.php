...
<head>
    ...
    <link href="css gerenciamento de usuario adm.css" rel="stylesheet">
...
<img src="Study2.png" class="logo"/></a>
    <div class="container">
        <div class="row mt-4">
            <div class="col-lg-12 d-flex justify-content-between align-items-center">
                <div>
                    <h4>Usuários Study Notes</h4>
                </div>
                <div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-9"><span id="senhaUsuario"></span></dd>

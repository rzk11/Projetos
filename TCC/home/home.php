  ...
  ?>  
    <div class="hero">
      <nav>
        ...
        <ul>
          <li><a href="/TCC/home/home.php">Home</a></li>
        ...
        <a href="/TCC/login/login.html" class="btn">Login</a>
      </nav>
...
<img src="/TCC/imagens/home.png" class="foto">
      <div class="content">
        ...
        <p>
          ...
          <br>
          Crie seu próprio horário personalizado com a <span class="desc">Grade Horária</span>
          <br>
          Coloque seus trabalhos/tarefas em um calendário para não se perder na <span class="desc">Agenda</span>
          <br>
          Faça seus próprios resumos em <span class="desc">Minhas Anotações</span>
          <br>
          Teste seu conhecimento em meus <span class="desc">Exercícios</span>
          <br>
          Anote seus afazeres na <span class="desc">To Do List</span>
        </p>
        <a href="/TCC/cadastro/cadastro.html" class="btn">Cadastrar</a>
      </div>
    </div>

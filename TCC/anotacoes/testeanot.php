<?php
include_once "conexao/conexao2.php";
...
if (!empty($pagina)) {
    ...
    $query_usuarios = "SELECT * FROM anotacao ORDER BY id_anotacoes DESC LIMIT $inicio, $qnt_result_pg";
    $result_usuarios = $conn->prepare($query_usuarios);
    $result_usuarios->execute();
    //a baixo o titulo das lisata
    ...
    $query_pg = "SELECT COUNT(id_anotacoes) AS num_result FROM anotacao";
